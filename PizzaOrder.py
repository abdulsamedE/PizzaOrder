...
def main():
    ...
    while code not in ["1", "2", "3", "4"]:
        code = input("Lütfen Menü Listesinden Seçim Yapınız!: ")

    order = class_dict[int(code)]()

    while code != "*":
        code = input("Ek Malzeme Seçmek İçin Numara Seçin (Otomatik Onaylamak İçin '*' Tuşuna Basın): ")
